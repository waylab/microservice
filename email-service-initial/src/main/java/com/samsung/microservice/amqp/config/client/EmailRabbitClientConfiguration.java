...
import com.samsung.microservice.amqp.config.AbstractEmailRabbitConfiguration;
import com.samsung.microservice.amqp.consumer.Receiver;

@Configuration
public class EmailRabbitClientConfiguration extends AbstractEmailRabbitConfiguration {

	protected static String QUEUE_NAME = "email-service";
